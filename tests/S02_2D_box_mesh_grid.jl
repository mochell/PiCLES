...
using PiCLES.Grids.CartesianGrid: TwoDCartesianGridMesh, ProjetionKernel
...
grid = TwoDCartesianGridMesh(10e3, 31, 10e3, 31)
#grid = TwoDCartesianGridMesh(30, 31, 30, 31)

heatmap(p, v.(grid.data.x, grid.data.y, 0))

M = ProjetionKernel(grid)
...
z = particle_system([log(4), 0.1, 0.1, 1.3, 0.2], [log(4), 0.1, 0.1, 1.3, 0.2], default_ODE_parameters, 0)
